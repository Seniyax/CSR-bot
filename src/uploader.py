...
def upload_embeddings(embeddings_path,batch_size=10):
    ...
    index = pc.Index(host="https://customer-support-ojqirsh.svc.aped-4627-b74a.pinecone.io")
    ...
    for i in range(0,len(embeddings),batch_size):
        ...
        vectors = [(item["id"],item["embedding"],item["metadata"]) for item in batch]
        try:
...
if __name__ == "__main__":
    embeddings_path = "data/embedding.json"
